...
const Gamification = () => {
  ...
  const stats = [
    ...
    { label: "Credits", value: 850, icon: Coins, color: "text-yellow-600" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="p-6 mb-8 bg-white border-yellow-200">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-2xl font-semibold text-yellow-800 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 p-4 rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-yellow-800 mb-2">Coffee Voucher</h4>
              <p className="text-sm text-yellow-600 mb-2">Free coffee at partner cafes</p>
              <Badge variant="outline" className="text-yellow-600 border-yellow-300">50 Credits</Badge>
            </div>
            
            <div className="bg-gray-50 p-4 rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-yellow-800 mb-2">Tech Gadgets</h4>
              <p className="text-sm text-yellow-600 mb-2">Discount on electronics</p>
              <Badge variant="outline" className="text-yellow-600 border-yellow-300">200 Credits</Badge>
            </div>
            
            <div className="bg-gray-50 p-4 rounded-lg border border-yellow-200">
              <h4 className="font-semibold text-yellow-800 mb-2">Grocery Discount</h4>
              <p className="text-sm text-yellow-600 mb-2">10% off at supermarkets</p>
              <Badge variant="outline" className="text-yellow-600 border-yellow-300">100 Credits</Badge>
            </div>
          </div>
        </Card>
